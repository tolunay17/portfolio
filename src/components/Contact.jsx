...
const Contact = () => {
  return (
    <div id='contact' className='max-w-[1040px] m-auto md:pl-20 p-4 py-16'>
        ...
        <form action="https://getform.io/f/9afd9c22-d3a9-4a89-9c24-a164e409b41a" method='POST' encType='multipart/form-data'>
            ...
            <button className='bg-[#000] text-gray-100 mt-4 w-full p-4 rounded-lg'>
                Send Message
            </button>
        </form>
    </div>
