    ...
    <div>
        ...
        { nav ? (
          ...
          href='#main' className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-grey-400 m-2 p-2 cursor-pointer hover:scale-110 ease-in duration-200'>
            ...
            <a onClick={handleNav} 
            href='#resume' className='w-[75%] flex justify-center items-center rounded-full shadow-lg bg-gray-100 shadow-grey-400 m-2 p-2 cursor-pointer hover:scale-110 ease-in duration-200'>
              <BsPerson size={20}/>
        ...
        <ul className='md:block hidden fixed top-[25%] z-10'>
          ...
          <li className='flex flex-col'>
            <a href="#resume" className='rounded-full shadow-lg bg-grey-100 shadow-gray-400 m-2 p-2 cursor-pointer hover:scale-110 ease-in duration-300'>
              <BsPerson size={20}/>
            </a>
          </li>
          <li className='flex flex-col'>
